...
def visualize_romania_graph(graph, path=None, title="Карта дорог Румынии"):
    ...
    # Расположение узлов (фиксированное для лучшей читаемости)
...
def visualize_path_in_graph(graph, path, graph_type="simple", title="Граф с найденным путем"):
    """
